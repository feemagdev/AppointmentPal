    ...
    return Column(
      children: [
        settingUI(
            ...
            onTap: (){
              print("add customer");
             BlocProvider.of<SettingScreenBloc>(context).add(AddCustomerEvent());
            }
        ),
        Divider(),
        settingUI(
            ...
            onTap: (){
              ...
              BlocProvider.of<SettingScreenBloc>(context).add(AutomatedScheduleEvent());
            }
        ),
        Divider(),
        settingUI(
            ...
            onTap: (){
              ...
              BlocProvider.of<SettingScreenBloc>(context).add(ManualBusinessHoursEvent());
            }
        ),
      ],
    );
